...
Open the Test Class:
- Navigate to the Test Class in the src/test/java directory (for example, AdminTests.java or LoginTests.java).
...
Run the Test Method:
- Place your cursor inside the test method you want to run (e.g., inside TCADMIN_001_searchUserAdmin).
